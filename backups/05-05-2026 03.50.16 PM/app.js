...
function updateScrollFade() {
    ...
    const atBottom = tableScrollWrap.scrollTop + tableScrollWrap.clientHeight
                     >= tableScrollWrap.scrollHeight - 8;
...
if (tableScrollWrap) tableScrollWrap.addEventListener('scroll', updateScrollFade, { passive: true });
if (tableScrollWrap) tableScrollWrap.addEventListener('wheel', e => {
