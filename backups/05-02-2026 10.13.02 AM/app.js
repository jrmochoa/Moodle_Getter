...
function toggleDateFilterDropdown(anchor) {
    ...
    const dd = document.createElement('div');
    dd.style.cssText = 'position:fixed;z-index:9999;background:rgba(7,0,18,.97);border:1px solid rgba(139,92,246,.3);border-radius:10px;padding:6px 0;min-width:190px;box-shadow:0 8px 32px rgba(0,0,0,.55);backdrop-filter:blur(12px)';
    ...
    clearBtn.style.cssText = 'background:none;border:none;cursor:pointer;font-size:11px;color:rgba(167,139,250,.55);padding:0;font-family:inherit';
    clearBtn.onmouseover = () => clearBtn.style.color = '#a78bfa';
    clearBtn.onmouseout  = () => clearBtn.style.color = 'rgba(167,139,250,.55)';
    ...
    const list = document.createElement('div');
    list.style.cssText = 'overflow-y:auto;max-height:280px;padding:2px 4px';

    function addSection(title, items, hiddenSet, keyOf, labelOf) {
        const sHdr = document.createElement('div');
        sHdr.style.cssText = 'padding:6px 8px 2px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:rgba(167,139,250,.3)';
